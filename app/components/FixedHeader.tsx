...
import { View, Text, StyleSheet, SafeAreaView, TextInput, TouchableOpacity, Animated, Dimensions, Platform, Image } from 'react-native';
    ...
    return (
        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.header}>
                ...
                {/* Title text has been removed as requested */}
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    ...
                                    if (isSearchActive && searchInputText) {
                                        ...
                                        // If there's text in the search field, either submit or clear

                                        if (searchInputText !== searchQuery) {

                                            handleSearchSubmit(); // Submit if text has changed

                                        } else {

                                            setSearchInputText(''); // Clear if submitted already
                                        ...
                                        toggleSearch(); // Otherwise toggle search bar
